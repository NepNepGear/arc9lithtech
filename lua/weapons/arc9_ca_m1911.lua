...
-- Print Names --
SWEP.PrintName = "M1911 MEU"
SWEP.Class = "Retired American WW2 Standard Pistol"
SWEP.Trivia = {
...
SWEP.ShootSound = "CA_port/ps/m1911/FIRE1.WAV"                            -- Fire
...
SWEP.AttachmentElements = {
	["ca_m1911_extended_magazine"] = {
        Bodygroups = {
            {2, 1}
        }
    },
	["ca_m1911_long_barrel"] = {
        Bodygroups = {
            {1, 1}
        }
    },
	["ca_m1911_short_barrel"] = {
        Bodygroups = {
            {1, 2}
        }
    },
...
SWEP.Attachments = {
    [1] = {
		...
		Category = {"ca_pistol_sights", "ca_m1911_mount"}, -- single or {"list", "of", "values"}
		Bone = "slide",
		Pos = Vector(0.04, 2.7, -0.2),
		Ang = Angle(0, 90, 180),
	},
	[2] = {
		PrintName = "Barrel",
		DefaultName = "Default 5 Inch Barrel",
		Category = {"ca_1911_barrel"}, -- single or {"list", "of", "values"}
		Bone = "weapon",
		Pos = Vector(0, 0.7, -0.7),
		Ang = Angle(0, 0, 0),
	},
	[3] = {
		PrintName = "Magazines",
		DefaultName = "Default 8 Rounder Magazine",
		Category = {"ca_1911_mags"}, -- single or {"list", "of", "values"}
		Bone = "weapon",
		Pos = Vector(0, 4, 4),
		Ang = Angle(0, 0, 0),
	},
	[4] = {
		...
		ExcludeElements = {"ca_m1911_mount"},
		Bone = "weapon",
		Scale = 0.5,
	...
	[5] = {
		PrintName = "Bullets",
		DefaultName = ".45 ACP FMJ",
		Category = {"ca_45acp"}, -- single or {"list", "of", "values"}
		Bone = "weapon",
		Pos = Vector(0, 3.5, 2),
		Ang = Angle(0, 0, 0),
	},
...
SWEP.ViewModel = "models/combat_arms_port/v_m1911.mdl"
SWEP.WorldModel = "" -- 
